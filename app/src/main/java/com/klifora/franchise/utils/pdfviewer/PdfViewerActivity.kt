...
import com.klifora.franchise.utils.pdfviewer.util.FileUtils.createPdfDocumentUri
...
import com.klifora.franchise.utils.pdfviewer.util.NetworkUtil.checkInternetConnection
import com.klifora.franchise.utils.pdfviewer.util.PdfEngine
import com.klifora.franchise.utils.pdfviewer.util.saveTo
import java.io.File
...
class PdfViewerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun launchPdfFromUrl(
            ...
            isPDFFromPath = false
            SAVE_TO_DOWNLOADS = saveTo == com.klifora.franchise.utils.pdfviewer.util.saveTo.DOWNLOADS
            return intent
        }
