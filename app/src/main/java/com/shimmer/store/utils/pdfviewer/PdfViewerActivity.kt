...
import com.shimmer.store.databinding.ActivityPdfViewerBinding
import com.shimmer.store.utils.pdfviewer.util.FileUtils.createPdfDocumentUri
...
import com.shimmer.store.utils.pdfviewer.util.NetworkUtil.checkInternetConnection
import com.shimmer.store.utils.pdfviewer.util.PdfEngine
import com.shimmer.store.utils.pdfviewer.util.saveTo
import java.io.File
...
class PdfViewerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun launchPdfFromUrl(
            ...
            isPDFFromPath = false
            SAVE_TO_DOWNLOADS = saveTo == com.shimmer.store.utils.pdfviewer.util.saveTo.DOWNLOADS
            return intent
        }
